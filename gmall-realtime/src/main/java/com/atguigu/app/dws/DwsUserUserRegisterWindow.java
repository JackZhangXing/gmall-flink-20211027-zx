 ...
 *
 * 开启zk,kf,mxw程序，修改db里面的application.properties，里面的日期改为今天和是否重置用户
 * 执行DwdUserRegister程序， 开启日志： lg.sh
 *
 * 开启一个消费者： bin/kafka-console-consumer.sh --bootstrap-server hadoop102:9092 --topic dwd_user_register
 *
 */
