 ...
 *
 * @author Star Zhang
 * @date 2022/4/27 23:54
 * 需要先开启DwdTradeOrderDetail，DwdTradePayDetailSuc程序
 */
...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        //TODO 8.提取事件事件、开窗、聚合
        SingleOutputStreamOperator<TradePaymentWindowBean> reduceDS = tradePaymentDS.assignTimestampsAndWatermarks(WatermarkStrategy.<TradePaymentWindowBean>forBoundedOutOfOrderness(Duration.ofSeconds(2)).withTimestampAssigner(
                new SerializableTimestampAssigner<TradePaymentWindowBean>() {
            @Override
