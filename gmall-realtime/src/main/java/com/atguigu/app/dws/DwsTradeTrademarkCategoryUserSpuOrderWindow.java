...
/**
 * DwsTradeTrademarkCategoryUserSpuOrderWindow
 *
 * @author Star Zhang
 * @date 2022/4/25 16:33
 * <p>
 * 需要开 DwdTradeOrderDetail程序
 */
...
//
//            @Override
//            public TradeTrademarkCategoryUserSpuOrderBean map(TradeTrademarkCategoryUserSpuOrderBean tradeTrademarkCategoryUserSpuOrderBean) throws Exception {
//                return null;
//            }
//        });
        ...
        SingleOutputStreamOperator<TradeTrademarkCategoryUserSpuOrderBean> tradeTrademarkCategoryUserSpuOrderDS = withCategory1DS.assignTimestampsAndWatermarks(WatermarkStrategy.<TradeTrademarkCategoryUserSpuOrderBean>forBoundedOutOfOrderness(Duration.ofSeconds(2)).withTimestampAssigner(
        ...
        //TODO 6.分组、开窗聚合
        KeyedStream<TradeTrademarkCategoryUserSpuOrderBean, String> keyedStream = tradeTrademarkCategoryUserSpuOrderDS.keyBy(new KeySelector<TradeTrademarkCategoryUserSpuOrderBean, String>() {
            @Override
