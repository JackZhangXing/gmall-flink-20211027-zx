 ...
 *
 * 描述：9.1流量域未经加工的事务事实表
 * 测试：①测试分流问题，不同主题测写到不同的流中②测试is_new字段的几种情况
 */
...
//        env.getCheckpointConfig().setCheckpointStorage("hdfs:xxx:8020//xxx/xx");
        ...
        //TODO 2.读取kafka topic_log主题的数据创建流
...
//                return value;
        ...
        //TODO 5.使用测输出流，对数据进行分流处理
        //页面浏览  主流
        //启动日志：侧输出流
        //曝光日志：侧输出流
        //动作日志：侧输出流
        //错误日志：侧输出流
        OutputTag<String> starTag = new OutputTag<String>("start") {
        };
                ...
                if (start != null) {
                    ...
                    if (displays != null &&displays.size() > 0) {
                        for (int i = 0; i < displays.size(); i++) {
                            ...
                            ctx.output(dirtyTag, display.toJSONString());
                        }
                    }
        ...
        //TODO 6.提取各个数据的数据
        DataStream<String> startDS = pageDS.getSideOutput(starTag);
