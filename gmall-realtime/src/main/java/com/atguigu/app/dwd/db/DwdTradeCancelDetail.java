...
public class DwdTradeCancelDetail {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 2.使用DDL获取kafka dwd_trade_order_detail 主题数据
        tableEnv.executeSql("" +
        ...
        //TODO 5.将数据写入kafka
        tableEnv.executeSql("" +
                "insert into dwd_trade_cancel_detail_table select * from filter_table").print();
